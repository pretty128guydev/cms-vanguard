...
const Risk = () => {
  ...
  //   ? data
  //       .filter(item => item.NavigationGroup === 'Risk')
  //       .filter(item => !item.ToggleGroup || toggleValues[item.ToggleGroup])
  //   : [];
  ...
  return (
    <div>
      <div className="mb-4">
        <h2 className="font-bold text-2xl">Risk</h2>
      </div>
